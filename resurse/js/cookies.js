...
window.addEventListener("load", function(){
    ...
    this.document.getElementById("ok_cookies").onclick=function(){
        setCookie("acceptat_banner",true,10*1000);
        document.getElementById("banner-container").style.display="none"
    }

    // this.document.getElementById("i_check1").onclick=function(){
    //     let checkbox_spalabil=document.getElementById("i_check1").value;

    //      setCookie("ce_cauti",checkbox_spalabil,60*600);
    // }
